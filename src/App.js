    ...
    <Layout>
      <Header className="header">
        <div className="pic">
          ...
          <Search placeholder="input search text" onSearch={onSearch} enterButton className="search" align="top" />
          <img className="minicart" src={minicart} alt={minicart} height="43px"></img><em>0</em>
